...
get_grid_function = {
    "Grib": get_lat_lon_from_grib,
    "netCDF": get_lat_lon_from_nc,
    "HDF5": get_lat_lon_from_HDF5
}

get_data_function = {
    "Grib": get_vars_from_grib,
    "netCDF": get_vars_from_nc,
    "HDF5": get_vars_from_HDF5
}

colormaps = {
    "pcp": {"map": ecmwf_pcp_cmap, "norm": ecmwf_pcp_norm},
...
postprocess_function = {
    "K_C": KelvinToCelsius,
    "IR_BT": IrradianceToBrightnessTemperature,
    "Z_dBZ": Reflectivity_dBZ,
    "m_mm": MetersToMilimeters,
    "tp_deode": compute_total_precipitation
}
