...
colormaps = {'pcp': {'map': ecmwf_pcp_cmap, 'norm': ecmwf_pcp_norm}, 'bt': {'map': bt_cmap, 'norm': bt_norm}, 'inverse_bt': {'map': inverse_bt_cmap, 'norm': inverse_bt_norm}, 'refl': {'map': refl_cmap, 'norm': refl_norm}}
